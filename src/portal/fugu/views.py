...
def index(request):
    return render(request, 'fugu/index.html')


def faq(request):
    return render(request, 'fugu/faq.html')


def terms(request):
    return render(request, 'fugu/terms.html')
...
def player(request):
    ...
    return render(request, 'fugu/player.html', context)
...
def monitoring(request):
    ...
    if not snapshot:
        return render(request, 'fugu/404.html')
    ...
    return render(request, 'fugu/monitoring.html', context)
...
def profile(request):
    if request.method != 'POST':
        return render(request, 'fugu/profile.html')
...
def rating(request):
    if request.method != 'POST':
        ...
        return render(request, 'fugu/rating.html', context)
...
def participate(request):
    if request.method != 'POST':
        return render(request, 'fugu/participate.html')
