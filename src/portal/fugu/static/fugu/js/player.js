...
function ControlBar() {
  ...
  const volume_on_img = 'url(/static/fugu/dist/images/volume-on.svg)';
  const volume_off_img = 'url(/static/fugu/dist/images/volume-off.svg)';
...
function init_player(params_json, csrf_token) {
  ...
  load_script('/static/fugu/js/fugu.js').onload = function() {
