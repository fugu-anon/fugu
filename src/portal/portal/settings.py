...
FUGU_BASE_DIR = os.path.dirname(os.path.dirname(BASE_DIR));

# Modify if needed: path of Fugu's YAML configuration file
yaml_config_path = os.path.join(FUGU_BASE_DIR, 'src', 'settings.yml')
...
STATIC_URL = '/static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'fugu', 'static')
