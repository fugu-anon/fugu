...
void WebSocketClient::init_abr_algo()
{
  ...
  } else if (abr_name_ == "fugu_raw") {
    abr_algo_ = make_unique<FuguRaw>(*this, abr_name_, abr_config_);
  } else if (abr_name_ == "fugu_ttp") {
    abr_algo_ = make_unique<FuguTTP>(*this, abr_name_, abr_config_);
  } else if (abr_name_ == "fugu_ttp_no_tcp_info") {
    abr_algo_ = make_unique<FuguTTP>(*this, abr_name_, abr_config_);
  } else if (abr_name_ == "fugu_ttp_mle") {
    abr_algo_ = make_unique<FuguTTP>(*this, abr_name_, abr_config_);
  } else {
