...
Fugu::Fugu(const WebSocketClient & client,
...
void Fugu::video_chunk_acked(Chunk && c)
{
...
VideoFormat Fugu::select_video_format()
{
  reinit();
...
void Fugu::deal_all_ban(size_t i)
{
  double min_v = 0;
...
size_t Fugu::update_value(size_t i, size_t curr_buffer, size_t curr_format)
{
...
double Fugu::get_qvalue(size_t i, size_t curr_buffer, size_t curr_format,
                        size_t next_format)
{
...
double Fugu::get_value(size_t i, size_t curr_buffer, size_t curr_format)
{
...
size_t Fugu::discretize_buffer(double buf)
{
